...
private:
  ...
  double _lb_packsize;		// PackSize for BTM LBs
  int _lb_nneighbors;	// Number of neighbors in a local node
 ...
 public:
  ...
  inline double & lbpacksize() { return _lb_packsize; }
  inline int & neighbors_count() { return _lb_nneighbors; }
